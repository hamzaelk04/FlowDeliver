            ...
            <div
                ...
                <div class="flex mb-6">
                    <div
                        ...
                        <label
                            ...
                            <input checked="" id="role-client" class="invisible w-0 h-0" name="role_selector" type="radio"
                                value="Client" />
                        </label>
                        <label
                            class="group flex cursor-pointer h-full grow items-center justify-center overflow-hidden rounded-lg px-2 has-[:checked]:bg-white dark:has-[:checked]:bg-gray-600 has-[:checked]:shadow-sm has-[:checked]:text-primary dark:has-[:checked]:text-white text-slate-500 dark:text-slate-400 text-sm font-medium transition-all duration-200">
                ...
                <div class="space-y-4">
                    ...
                    <label class="flex flex-col w-full">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" id="password-toggle"
                                ...
                                <span id="password-toggle-icon" class="material-symbols-outlined text-[20px] text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 transition-colors">visibility</span>
                            </button>
                        </div>
                    </label>
                    <label class="flex flex-col w-full">
                    ...
                    <div id="vehicle-field" class="flex flex-col w-full" style="display: none;">
                        <p class="text-slate-900 dark:text-white text-sm font-medium leading-normal pb-2">Vehicle</p>
                        <div class="relative">
                            <select
